...
public class KafkaConsumerConfig {
  ...
  @Value("${kafka-tutorial.consumer.group-id}")
  private String groupId;

  @Value("${kafka-tutorial.consumer.auto.commit.interval.ms}")
  private String autoCommitIntervalMs;

  @Value("${kafka-tutorial.consumer.session.timeout.ms}")
  private String sessionTimeoutMs;

  @Value("${kafka-tutorial.consumer.auto.offset.reset}")
